# saboreq-flix
[![saboreq-flix Image](.github/saboreq-flix.png)](https://docs.undi.rest)  
...
|----------------|------------------------------------------------------------------|----------------------------------------------------------|
| saboreq-flix Docs | [sudo-docs](https://docs.undi.rest)                          | [source code](https://github.com/sussy-code/docs)        |
...
| Frontend       | [saboreq-flix](https://docs.undi.rest/instances)                | [source code](https://github.com/sussy-code/smov)        |
...
## Running Locally
Type the following commands into your terminal / command line to run saboreq-flix locally
```bash
...
## Updating a saboreq-flix Instance
To update a saboreq-flix instance you can type the below commands into a terminal at the root of your project.
```bash
...
git commit -m "Update saboreq-flix instance (merge upstream/main)"
git push  # Push to YOUR repository
```


## Contact Me
**Email:** *[dev@saboreq-flix.lol](mailto:dev@saboreq-flix.lol)* 
